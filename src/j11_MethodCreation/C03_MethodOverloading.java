...
public class C03_MethodOverloading {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(str.indexOf('C'));//4
        System.out.println(str.indexOf("C", 3));//4  java nın overloadingi
...
topla(3.5,8.9);//
    ...
    public static void topla(double sayi1, int sayi2) {
        System.out.println("doable-int type method çalıştı -> " + (sayi1 + sayi2));

    }

    public static void topla (int sayi1, double sayi2) {
        System.out.println("int-doable type method çalıştı -> "+(sayi1+sayi2));

    }
    public static void topla (double sayi1, double sayi2) {
        System.out.println("doable-doable type method çalıştı -> "+(sayi1+sayi2));
