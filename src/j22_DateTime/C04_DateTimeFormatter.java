...
public class C04_DateTimeFormatter {
    public static void main(String[] args) {
        ...
        System.out.println("ldt = " + ldt);//2022-10-25T23:20:04.185233200
        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd - MMMM - YY");//gün ayİsmi yıl formatı tanımlandı
        System.out.println("dtf.format(ldt) = " + dtf.format(ldt));//25 - Ekim - 22

        DateTimeFormatter dtf1 = DateTimeFormatter.ofPattern("hh:mm:ss a");// saat dakika saniye am format
        System.out.println("dtf1.format(ldt) = " + dtf1.format(ldt));//11:23:15 ÖS
